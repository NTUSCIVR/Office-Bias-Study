	...
	public class Hand : MonoBehaviour
	{
		...
		public Transform GetAttachmentTransform( string attachmentPoint = "" )
		{
			...
			if ( !attachmentTransform )
			{
                ...
                attachmentTransform = hoverSphereTransform;
            }
		...
		public void AttachObject( GameObject objectToAttach, AttachmentFlags flags = defaultAttachmentFlags, string attachmentPoint = "" )
		{
            ...
            objectToAttach.GetComponent<Interactable>().isInteracted = true;
            objectToAttach.GetComponent<Interactable>().isAttachedToHand = true;
            UpdateHovering();
		}
		...
		public void DetachObject( GameObject objectToDetach, bool restoreOriginalParent = true )
		{
            ...
            objectToDetach.GetComponent<Interactable>().isAttachedToHand = false;
            CleanUpAttachedObjectStack();
		}
